...
Just a tool to manage common javascript libraries, base LazyLoad.

See qunit at http://benz303.github.com/lib.js
...
== Example
  ...
  LazyLoad.jqueryui(function(){
    // something use jqueryui to do
  });
  
More Options see https://github.com/benz303/lib.js/blob/gh-pages/default.yml
